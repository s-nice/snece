...
class AdverController extends AdminBase
{
	/**
	...
	{
		$model=new Adver('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Adver']))
			$model->attributes=$_GET['Adver'];
	 ...
	 * @param Adver $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='adver-form')
		{
